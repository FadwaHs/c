...
coordonnees c={0,0},c0={5,1},c1={30,1},c2={30,180},c3={30,140},c4={30,230},c5={30,280},c6={30,330},c7={30,380},
...
eventbox = Init_Event_box(F->window,"eventbox1",d2,&couleur1);
eventbox = creer_Event_Box(eventbox,FALSE);

// //create image 
// MonImage *Im;
// Im=init_image("standing-up-man-.png","",c,NULL);
// Im=creer_image(Im);

// //add to event box
// ajouter_Event_Box(eventbox->eventbox.elem,Im->image.elem);

//add signal
ADD_Event_To_Box(eventbox,"button_press_event",button_pressed , F->window, 1);
