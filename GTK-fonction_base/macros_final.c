...
/**********************************fonction du couleur***********************************/
/*La fonction : add_bgcolor
  -Entrees :  
             widget : Un pointeur sur GtkWidget 
             couleur : la couleur d'un Widget 
             opc : opacity 
  -Description: Cette fonction permet de changer la couleur d'un Widget */
...
/*************************************************************
  ...
  -Entrees :  -titre de la fenetre
             ...
             - la couleur de fenetre
             -la taille des bordure de fenetre
...
/*****************************positionnement de la fenetre ********************************
 ...
 Entree :Un pointeur vers la structure Fenetrr initialisee
...
/************************ La fonction : creer_Window *************************************
 ...
 Entree :Un pointeur vers la structure Fenetre initialisee
 Sortie :  Un pointeur vers la variable W (Fenetre)
...
/*************************creer box************************************
 ...
 Entree :  Un pointeur vers la structure MonBox initialisee
...
/*************************************************************
 ...
 Entree :-Un pointeur vers la structure MonBox initialisee et cree
         -un pointeur sur un element (fils) qui sera inserer dans le box
...
/************************************************************
 ...
 -Entrees : -titre du Grid
            -conteneur du Grid
            -les coordonnees
            -la dimension de Grid
            -la couleur de Grid
 -Sortie : La structure widg (grid) apres initialisation et création
 -Description : Cette fonction permet deallouer de leespace memoire pour
 notre variable de type widg (grid), leinitialise et le creer
...
Entree : -Un pointeur vers la structure widg initialisee
...
-Entrees : -mere : la mere du button
           ...
           -type:le type du bouton (normal,radio,check...)
           -mnemo:(cration du bouton soit avec label ou bien avec mnemoniac)
           -couleur : la couleur de button 
           - cord : les coordonnes de button
...
/**********************************************************
 La fonction :ajouter_image_button
-Entrees : B : objet bouton initialise
-Sortie : void 
-Description: Cette fonction permet d'ajouter une image a un button B
***********************************************************/
...
/**********************************************************
 ...
 La fonction :ajouter_icon_button
-Entrees : B : objet bouton initialise
-Sortie : void 
-Description: Cette fonction permet d'ajouter un icone a un button B
...
/**********************************************************
 La fonction :  Afficher_widget
-Entrees : F : un pointeur sur GtkWidget
-Sortie : void 
-Description: Cette fonction permet d'afficher un widget
***********************************************************/
...
/**
   ...
   dimension:  gint height       :indique la longueur du spin button
               ...
               bgcolor           :indique la couleur du spin button 
               cord              :indique les coordonnees du spin button 
               conte             :indique le conteneur
...
typedef struct
{
    ...
    coordonnees C;      // les coordonnees d'objet scale
...
/*************************************************************
  ...
  -Entrees :  -pere ou conteneur du scale
              ...
              - un entier (domD): determinant le domain des pas soit des reels (1)
                ou des entiers (0)
              - cord : determinant les coordonnees du Scale
...
/*************************************************************
 ...
 Entree :Un pointeur vers la structure MonScale initialisee
...
/// Initialiser fixed ----------------------------------------------------------------
/**
   La fonction : Init_Fixed
  -Entrees : -Dimension du fixed
            - titre du fixed
            - le conteneur affecter aux fixed
            - coordonnees du fixed
      
  -Sortie: La structure Monfixed apres initialisation
  -Description: Cette fonction permet d'allouer de l'espace memoire pour
         notre variable de type Monfixed et de l'initaliser
**/
...
//TODO:: couleur enlevee

/// Creer Fixed --------------------------------------------------------------
/**
 La fonction : creer_Fixed
 Entree :Un pointeur vers la structure Monfixed
           initialisee
 Sortie :  Un pointeur vers la variable F (Monfixed)
 Description : Cette fonction permet de creer un fixed en
 Fonction des parametres recuperes de la structure Monfixed
...
/**
 La fonction : ajouter_Fixed

 Entree :  - Un pointeur vers la structure Monfixed initialisee et cree
           - un pointeur sur un element (fils) qui sera inserer dans le fix
           - les coordonnees c 
 Sortie :  Un pointeur vers la variable F (Monfixed)
 Description : Cette fonction permet d'ajouter une widget dans un fixed
...
typedef struct
{
    GtkWidget* barre; // la barre 
    dimension dim;    // la dimmension 
    color_widg * coleur; // la couleur 

}bar_menu;


///******************************** Ajouter couleur Menu******************************************************/
/**
 La fonction : color_menu

 Entree :  - Un pointeur vers la structure MonMenu initialisee et cree
           - le choix : 
               1 :  colorer la tete du menu
               2 :  colorer les elements du menu
               3 :  les deux
           - la coleur C 

 Sortie :  Un pointeur vers la variable M (MonMenu)
 Description : Cette fonction permet d'ajouter une couleur a un menu */
...
///******************************** Ajouter Menu bar ****************************/
/**
 La fonction : Creer_bar_menu

 Entree :  - d : la dimension du menu bar 
           - couleur : la coleur  du menu bar 

 Sortie :  Un pointeur vers la variable MaBar (bar_menu)
 Description : Cette fonction permet de creer un menu bar */
...
/**************************** Ajouter elem barre ****************************************************/
/*****************************************************************************************************
 La fonction : Ajouter_elm_bar

 Entree :  - Un pointeur vers l'element de type bar_menu
           - label

 Sortie :  Un pointeur vers la variable elem (GtkWidget)

 Description : Cette fonction permet d'ajouter un element aux menu bar*/
/**********************************************************/
...
/**************************************************************************/
/*************************** initialiser menu******************************
 La fonction : init_menu
 Entree :  lebel : le titre de menu
 Sortie :  La structure MonMenu apres initialisation
 Description : Cette fonction permet d'allouer de l'espace memoire pour notre variable de type
                   MonMenu et de l'initaliser
*************************************************************/
...
/******************************************************************************/
/*********************************Creer_Menu***********************************
 La fonction : Creer_Menu
 Entree :Un pointeur vers la structure MonMenu initialisee
 Sortie :  Un pointeur vers la variable monMenu apres la creation
 Description : Cette fonction permet de creer un Menu en
Fonction des parametres recuperes de la structure MonMenu
*************************************************************/
...
/*****************************creer un menu dans une barre specifique*****************
 La fonction : Creer_Menu_barre
 Entree :  - monMenu : Un pointeur vers la structure MonMenu
           - bar : Un pointeur vers  bar_menu

 Sortie :  Un pointeur vers la variable monMenu(MonMenu)
 Description : Cette fonction permet de creer un menu dans une barre specifique
*************************************************************/
...
/*****************************ajouter un element menu*****************
 La fonction : Ajouter_elem
 Entree :  - monMenu : Un pointeur vers la structure MonMenu
           - label : le titre de menu item
           - la couleur de menu item
           - pos : la position 

 Sortie :  Un pointeur vers la variable ptr_item (GtkWidget)
 Description : Cette fonction permet d'ajouter un element aux Menu
*************************************************************/
...
GtkWidget * Ajouter_elem(MonMenu* monMenu,gchar* label,color_widg * couleur,place_elem* pos )
{
    ...
    return (GtkWidget*)ptr_item;
}

/************************************************************************************************/
/*****************************Ajouter un sous-menu****************
 La fonction : Ajouter_sous_menu
 Entree :  - menu_principale : Un pointeur vers la structure MonMenu , c'est le menu principale
           - Sous_Menu : Un pointeur vers la structure MonMenu , c'est le sous menu de menu principale
           - pos : la position 

 Sortie :  Un pointeur vers la variable Sous_Menu (MonMenu)
 Description : Cette fonction permet d'ajouter un sous Menu a un Menu Principale
*************************************************************/
...
-Entrees :  -dimention : la dimention du entry
            -conten : le conteneur du entry
            -txt : le texte du entry
            -visible : la visibility du entry          

-Sortie :  Objet Entry (MonEntry)
-Description: Cette fonction permet d'allouer de l'espace pour
 la structure de type MonEntry, d'initialiser
 ses champs et de la retourner .
***********************************************************/
...
-Entrees  : objet entry initialise
-Sortie   : Objet entry creer
-Description: Cette fonction permet la creation d'un entry
 en fct des parametres recuperes de la structure
 MonEntry initialisee.
***********************************************************/
...
/*************************************************************
   La fonction : init_dialog

  -Entrees :  -pere ou conteneur du dialog
              -titre du dialog
              -icon de dialog
              - dim : la dimension 
              - couleur de widget
              - cord : determinant les coordonnees du dialog

  -Sortie: La structure MonDialog apres initialisation

  -Description: Cette fonction permet d'allouer de l'espace memoire pour notre variable de type
                   MonDialog et de l'initaliser
...
/*************************************************************
 La fonction : creer_dialog
 Entree :Un pointeur vers la structure MonDialog initialisee
 Sortie : void
 Description : Cette fonction permet de creer un dialog en
Fonction des parametres recuperes de la structure MonDialog
*************************************************************/
...
/*************************************************************
 La fonction : ajouter_button_dialog
 Entree :   -Un pointeur vers la structure MonDialog 
            - buttonlabel :label du button 
            - idbutton : identidiant de button
 Sortie : button de type GtkWidget
 Description : Cette fonction permet d'ajouter un button aux dialog
*************************************************************/
...
/*************************************************************
 La fonction : ajouter_content_area
 Entree :   -Un pointeur vers la structure MonDialog 
            - elem : l'element a ajouter to content area
            
 Sortie : void
 Description : Cette fonction permet d'ajouter un element  to  content_area d'un  dialog
*************************************************************/
...
/*************************************************************
 La fonction : ajouter_icon_dialog
 Entree :    -Un pointeur vers la structure MonDialog 
            - type_icon : le type d'icne a ajouter
            
 Sortie : void
 Description : Cette fonction permet d'ajouter un icone  to dialog
*************************************************************/
...
//INNITIALISATION
/*************************************************************
   La fonction : init_comboBox

  -Entrees :  -pere ou conteneur du comboBox
              -titre du comboBox
              - dim : dimension de comboBox
              - cord : determinant les coordonnees du Scale
              - le type

  -Sortie: La structure MMonComboBox  apres initialisation

  -Description: Cette fonction permet d'allouer de l'espace memoire pour notre variable de type
                   MonComboBox et de l'initaliser
...
/*************************************************************
 La fonction : creer_comboBox
 Entree :  Un pointeur vers la structure MonComboBox initialisee
 Sortie :  Un pointeur vers la variable comb (MonComboBox) apres la creation
 Description : Cette fonction permet de creer ComboBox en
Fonction des parametres recuperes de la structure MonComboBox
*************************************************************/
...
///** AJOUTER UN TEXTE**///
/*************************************************************
 La fonction : ajouter_string_comboBox
 Entree :   -Un pointeur vers la structure MonComboBox 
            - element : l'element a ajouter to MonComboBox 
            
 Sortie : Un pointeur vers la variable comb (MonComboBox)
 Description : Cette fonction permet d'ajouter un texte aux ComboBox
*************************************************************/
...
/*************************************************************
 La fonction : ajouter_number_comboBox
 Entree :   -Un pointeur vers la structure MonComboBox 
            - num : le nombre a ajouter to MonComboBox 
            
 Sortie : Un pointeur vers la variable comb (MonComboBox)
 Description : Cette fonction permet d'ajouter un nombre aux ComboBox
*************************************************************/
...
/*********************** initialisation***************************************
   La fonction : init_Scroll

  -Entrees :  -pere ou conteneur du Scroll
              - le conteneur fils 
              -brw de type gint
              - la dimension de scroll 

  -Sortie: La structure MonScroll apres initialisation

  -Description: Cette fonction permet d'allouer de l'espace memoire pour notre variable de type
                   MonScroll et de l'initaliser
...
///creation**********************************************
/*************************************************************
 La fonction : creer_Scroll
 Entree :  Un pointeur vers la structure MonScroll initialisee
 Sortie :  Un pointeur vers la variable scroll ( MonScroll ) apres la creation
 Description : Cette fonction permet de creer un Scroll en
Fonction des parametres recuperes de la structure MonScroll
*************************************************************/
...
/*************************************************************
  ...
  -Entrees :  -url : url de l'image
              -titre du l'image 
              - cord : determinant les coordonnees du l'image
              - cont : pere ou conteneur d'image

  -Sortie: La structure MonImage apres initialisation

  -Description: Cette fonction permet d'allouer de l'espace memoire pour notre variable de type
                   MonImage et de l'initaliser
...
/*************************************************************
 La fonction : creer_image
 Entree :Un pointeur vers la structure MonImage initialisee
 Sortie :  Un pointeur vers la variable M (MonImage) apres la creation
 Description : Cette fonction permet de creer une image en
Fonction des parametres recuperes de la structure MonImage
*************************************************************/
...
/*************************************************************
 La fonction : creat_toolbar
 Entree :     - color : la couleur de toolbar 
              - cont : pere ou conteneur du toolbar
              - d : la dimension de toolbar

 Sortie :  Un pointeur vers la variable p (Montool) apres la creation
 Description : Cette fonction permet de creer un toolbar en
 Fonction des parametres d'Entree
...
Montool * creat_toolbar(color_widg *color,GtkWidget *cont,dimension d){
    ...
    B=Init_box(NULL,"tool",'v',0,d,0,0,color,walo());
    B=creer_Box(B);
    if(cont)
        p->cont=cont;
    else p->cont=NULL;
...
/*************************************************************
 La fonction :  creat_toolitem
 Entree :     - Un pointeur vers la structure Montool
              - icone : icone de tooliten 
              - pos: la position des items

 Sortie :  Un pointeur vers la variable p (Montool)
 Description : Cette fonction permet de creer un toolitem pour un toolbar
...
/*************************************************************
  ...
  -Entrees :  -pere ou conteneur du Event_box
              -dim : dimension de Event_box
              -couleur du Event_box 


  -Sortie: La structure MonEventBox apres initialisation

  -Description: Cette fonction permet d'allouer de l'espace memoire pour notre variable de type
                   MonEventBox et de l'initaliser

*************************************************************/
MonEventBox*Init_Event_box(GtkWidget*pere,dimension dim,color_widg *couleur)
{
...
/********************creer Event_box**************************
 La fonction : creer_Event_Box
 Entree : - Un pointeur vers la structure MonEventBox initialisee
          - above_child de type gboolean

 Sortie :  Un pointeur vers la variable B (MonEventBox) apres la creation
 Description : Cette fonction permet de creer un EventBox en
Fonction des parametres recuperes de la structure MonEventBox
*************************************************************/
...
/********************ajouter_Event_Box**************************
 ...
 Entree : - B : Le GTK Container
          - fils :  le fils de container

 Sortie :void 
 Description : Cette fonction permet d'ajouter un element un EventBox
 ...
 * 
 ...
 Entree : - eventbox de type GtkWidget
          - event de type GdkEventButton
          - data de type gpointer

 Sortie : de type gboolean
 Description : Cette fonction is called every time a button-press event occurs on the GtkEventBox
*************************************************************/
...
static gboolean button_pressed (GtkWidget *eventbox,GdkEventButton *event,gpointer *data)
{
    if (event->type == GDK_BUTTON_PRESS)
    {
        ...
        //create image
        MonImage *Im;
        Im=init_image("standing-up-man-.png","",walo(),NULL);
        Im=creer_image(Im);
...
///ADD_Event_To_Box -----------------------------------------------------------
/**
 La fonction : ADD_Event_To_Box

 Entree :  - Un pointeur vers la structure MonEventBox initialisee et creer
           - name : le nom de signal
           - function_name : le nom de fonction rappeler
            -child : le child de type GtkWidget
           - num_event : le numero pour les GdkEventMask Values
 Sortie : void
 Description : Cette fonction permet d'ajouter un signal aux eventbox
...
/*************************************************************
   La fonction : init_expander
  -Entrees : 
              - titre du expander
              - label d'expander
              - bt : button du expander
              - cont : pere ou conteneur du d'expander

  -Sortie: La structure MonExpander apres initialisation
  -Description: Cette fonction permet d'allouer de l'espace memoire pour notre variable de type
                   MonExpander et de l'initaliser
...
/*************************************************************
 La fonction : creer_expander
 Entree : Un pointeur vers la structure MonExpander initialisee
 Sortie : void
 Description : Cette fonction permet de creer un expander en
Fonction des parametres recuperes de la structure MonExpander
*************************************************************/
...
/********************add_to_expander**************************
 * 
 La fonction : add_to_expander
 Entree : - expander : Le GTK Container
          - fils :  le fils de container

 Sortie :void 
 Description : Cette fonction permet d'ajouter un element un expander
...
/*************************************************************
   La fonction : init_headbar
  -Entrees : 
              -titre du headbar
              -sous titre du headbar :
              - close :
              - agrandir :
              - minimize :

  -Sortie: La structure Monheadbar apres initialisation
  -Description: Cette fonction permet d'allouer de l'espace memoire pour notre variable de type
                   Monheadbar et de l'initaliser
...
/**********************************************************************************/
///*** decoration la hraderbar  ****///
/*************************************************************
   La fonction : decoration_header
  -Entrees : 
              - Un pointeur vers GtkHeaderBar
              - close :
              - maximize:
              - minimize :
  -Sortie:void
  -Description: Cette fonction permet de decorer le header bar
...
/**********************************************************************************/
/*************************************************************
 La fonction : creer_headbar
 Entree : Un pointeur vers la structure Monheadbar initialisee
 Sortie : Void
 Description : Cette fonction permet de creer un headerbar en
Fonction des parametres recuperes de la structure Monheadbar
*************************************************************/
...
/**********************************************************************************/
/*************************************************************
 La fonction : Ajouter_to_headbar
 Entree :  - Un pointeur vers GtkWidget headbar
           - child : l'element a ajouter
           - type : 1 ajouter au debu / 2 ajouter au fin
 Sortie : Void
 Description : Cette fonction permet d'ajouter un element au headbar
*************************************************************/
...
/*************************************************************
 La fonction : cree_Dliste
 Entree :  la valeur de cellule
 Sortie :  Un pointeur vers la variable NE (Dliste) apres la creation
 Description : Cette fonction permet de creer un element d'une Dliste initialiser par une valeur
*************************************************************/

Dliste* cree_Dliste(GtkWidget* valeur)
{
...
/*************************************************************
 La fonction : inserer_fin
 Entree :  - la valeur a inserer
           - l: La liste de type Dliste
 Sortie :  Un pointeur vers la variable L (Dliste) apres l'insertion
 Description : Cette fonction permet d'inserer un element a la fin de la liste
*************************************************************/

Dliste* inserer_fin(Dliste* L,GtkWidget* valeur)
{
    Dliste*NE,*crt;
