...
MonBox *box=NULL;
box=Init_box(NULL,"sousbox1",'V',1,d2,1,3,&couleur2); 
box=creer_Box(box);
fix=ajouter_Fixed(fix,box->box.elem,c1);
...
MonBox *box3=NULL;
box3=Init_box(NULL,"sousbox1",'H',1,d2,1,3,&couleur1); 
box3=creer_Box(box3);
fix=ajouter_Fixed(fix,box3->box.elem,c2);
...
MonBox *box5=NULL;
box5=Init_box(NULL,"sousbox1",'H',1,d2,1,3,&couleur1); 
box5=creer_Box(box5);
fix=ajouter_Fixed(fix,box5->box.elem,c5);
...
MonBox *box9=NULL;
box9=Init_box(NULL,"sousbox1",'H',1,d2,1,3,&couleur1); 
box9=creer_Box(box9);
fix=ajouter_Fixed(fix,box9->box.elem,c7);
 ...
 ////ADD Combobox date and label 
   ...
   labelmois=creer_label(labelmois);
    ...
    combobox_add(comb2,"0");
    combobox_add(comb2,"1");
    combobox_add(comb2,"3");
    combobox_add(comb2,"4");
   ...
   labelannee=creer_label(labelannee);
    ...
    combobox_add(comb3,"0");
    combobox_add(comb3,"2020");
    combobox_add(comb3,"2021");
    combobox_add(comb3,"2019");
...
MonBox *box7=NULL;
box7=Init_box(NULL,"sousbox1",'H',1,d2,1,3,&couleur1); 
box7=creer_Box(box7);
fix=ajouter_Fixed(fix,box7->box.elem,c10);
...
//Deux Button Simple Quitter et Ajouter
...
//Création des GTKEntry

MonBox *boxentry=NULL;
boxentry=Init_box(NULL,"sousbox1",'V',1,d2,1,0,&couleur1); 
boxentry=creer_Box(boxentry);
fix=ajouter_Fixed(fix,boxentry->box.elem,c12);

Monlabel* labelentry=NULL;
labelentry=init_label("label principale","Login:",boxentry->box.elem,d5,NULL);
labelentry=creer_label(labelentry);
...
Monlabel* labelentry1=NULL;
labelentry1=init_label("label principale","Password:",boxentry->box.elem,d5,NULL);
labelentry1=creer_label(labelentry1);

MonEntry *entry1;
entry1 = init_MonEntry(d4,FALSE,TRUE,NULL,NULL,"entry1",0,&couleur1);
entry1 = creer_entry(entry1);

boxentry=ajouter_Box(boxentry,entry1->entry,0,0,0,1);
