...
POS p;
p.pos='C';
dimension d={600,700},d2={0,400},d3={40,10},d4={5,10},d5={0,0},d6={500,500},d7={5,130},d8={100,100},d9={5,50};

coordonnees c={0,0},c0={5,1},c1={30,5},c2={30,160},c4={30,260},c5={30,360},c6={30,330},c7={30,380},
             c8={30,430},c9={300,480},c10={290,600},c11={290,680},c12={5,740},c121={5,800},c13={5,880};
...
// fix=ajouter_Fixed(fix,Im->image.elem,c);
 ...
 MonFrame *FF;
 FF=init_Frame(NULL,walo2(),0.0,1.0,"",0,walo(),&couleur3);
 FF=creer_Frame(FF);

//creation Des Menus Dans Un Box Vertical 
MonBox *box=NULL;
box=Init_box(FF->frame.elem,"sousbox1",'V',1,d2,1,4,&couleur1); 
box=creer_Box(box);

fix=ajouter_Fixed(fix,FF->frame.elem,c1);


MonMenu *Me=NULL,*Me2=NULL,*Me3=NULL,*Me4=NULL,*Me5=NULL,*Me6=NULL;

Me=init_menu("MonChoix",box->box.elem);
Creer_Menu(Me);
Me2=init_menu("VotreChoix",box->box.elem);
Me3=init_menu("LeurChoix",box->box.elem);
Creer_Menu_barre(Me->barre,Me2);
Creer_Menu_barre(Me->barre,Me3);

//VotreChoix
GtkWidget *elem1;
elem1=Ajouter_elem(Me2,"Sous Choix1",&couleur2);
GtkWidget *elem2;
elem2=Ajouter_elem(Me2,"Sous Choix2",&couleur2);

Me4=init_menu("Sous Choix 3",Me2->menu);
Creer_Menu(Me4);
Creer_sous_menu(Me2,Me4);


GtkWidget *elem3;
elem3=Ajouter_elem(Me4,"Choix221",&couleur2);
GtkWidget *elem4;
elem4=Ajouter_elem(Me4,"Choix222",&couleur2);
GtkWidget *elem5;
elem5=Ajouter_elem(Me4,"Choix223",&couleur2);

//LeurChoix
GtkWidget *elem1Me3;
elem1Me3=Ajouter_elem(Me3,"Sous Choix1",&couleur2);
GtkWidget *elem2Me3;
elem2Me3=Ajouter_elem(Me3,"Sous Choix2",&couleur2);

Me5=init_menu("Sous Choix 3",Me3->menu);
Creer_Menu(Me5);
Creer_sous_menu(Me3,Me5);


GtkWidget *elemMe5;
elemMe5=Ajouter_elem(Me5,"Choix221",&couleur2);
GtkWidget *elem1Me5;
elem1Me5=Ajouter_elem(Me5,"Choix222",&couleur2);
GtkWidget *elem2Me5;
elem2Me5=Ajouter_elem(Me5,"Choix223",&couleur2);

//MonChoix

GtkWidget *elem1Me;
elem1Me=Ajouter_elem(Me,"Sous Choix1",&couleur2);

Me6=init_menu("Sous Choix 2",Me->menu);
Creer_Menu(Me6);
Creer_sous_menu(Me,Me6);

GtkWidget *elemMe6;
elemMe6=Ajouter_elem(Me6,"Choix221",&couleur2);
GtkWidget *elem1Me6;
elem1Me6=Ajouter_elem(Me6,"Choix222",&couleur2);
GtkWidget *elem2Me6;
elem2Me6=Ajouter_elem(Me6,"Choix223",&couleur2);

GtkWidget *elem2Me;
elem2Me=Ajouter_elem(Me,"Sous Choix3",&couleur2);



//creation de 1er Frame
 MonFrame *FF1;
 FF1=init_Frame(NULL,walo2(),0.0,1.0,"Vos ConnaissanceS dE Gtk+",1,walo(),&couleur4);
 FF1=creer_Frame(FF1);

//Création Label
// MonBox *box1=NULL;
// box1=Init_box(NULL,"sousbox1",'V',0,d2,0,3,&couleur2); 
// box1=creer_Box(box1);
// fix=ajouter_Fixed(fix,box1->box.elem,c3);

// Monlabel* label=NULL;
// label=init_label("label principale","Vos ConnaissanceS dE Gtk+ ",box1->box.elem,d3,NULL);
// label=creer_label(label);

//Creation Des Buttons Dans Un Box Horizental
MonBox *box3=NULL;
box3=Init_box(FF1->frame.elem,"sousbox1",'H',1,d2,1,2,&couleur1); 
box3=creer_Box(box3);

/// Bouton radio
MonBouton *bouton1,*bouton2,*bouton3,*bouton4;
bouton1=init_Button(NULL,NULL,NULL,d4,"Faible",NULL,2,0,&couleur1);
bouton1=creer_Bouton(bouton1);
bouton2=init_Button(bouton1->button.elem,NULL,NULL,d4,"Moyenne",NULL,2,0,&couleur1);
bouton2=creer_Bouton(bouton2);
bouton3=init_Button(bouton1->button.elem,NULL,NULL,d4,"Bien",NULL,2,0,&couleur1);
bouton3=creer_Bouton(bouton3);
bouton4=init_Button(bouton1->button.elem,NULL,NULL,d4,"Tres Bien",NULL,2,0,&couleur1);
...
box3=ajouter_Box(box3,bouton4->button.elem,0,0,0,1);

fix=ajouter_Fixed(fix,FF1->frame.elem,c2);


//Création 2em frame

 MonFrame *FF2;
 FF2=init_Frame(NULL,walo2(),0.0,1.0,"Vos Commentaire Sure Gtk+ ",1,walo(),&couleur4);
 FF2=creer_Frame(FF2);


// MonBox *box4=NULL;
// box4=Init_box(NULL,"sousbox1",'V',0,d2,0,3,&couleur2); 
// box4=creer_Box(box4);
// fix=ajouter_Fixed(fix,box4->box.elem,c4);

// Monlabel* label1=NULL;
// label1=init_label("label principale","Vos Commentaire Sure Gtk+ ",box4->box.elem,d3,NULL);
// label1=creer_label(label1);

//creation des Button type chekbox

MonBox *box5=NULL;
box5=Init_box(FF2->frame.elem,"sousbox1",'H',1,d2,1,3,&couleur1); 
box5=creer_Box(box5);
...
fix=ajouter_Fixed(fix,FF2->frame.elem,c4);
...
// MonBox *box8=NULL;
// box8=Init_box(NULL,"sousbox1",'V',0,d2,0,3,&couleur2); 
// box8=creer_Box(box8);
// fix=ajouter_Fixed(fix,box8->box.elem,c6);

// Monlabel* label3=NULL;
// label3=init_label("label principale","Choix Date : ",box8->box.elem,d3,NULL);
...
box9=creer_Box(box9);
 ...
 ////ADD Combobox date and label 
   ...
   labelannee=creer_label(labelannee);
    ...
    fix=ajouter_Fixed(fix,FF3->frame.elem,c5);
...
//add combobox de votre choix :
   ...
   fix=ajouter_Fixed(fix,boxchoix->box.elem,c8);
...
//Création 4em frame
 ...
 MonFrame *FF4;
 FF4=init_Frame(NULL,walo2(),0.0,1.0,"Le Covid-19 est : ",1,walo(),&couleur4);
 FF4=creer_Frame(FF4);

// MonBox *box6=NULL;
// box6=Init_box(NULL,"sousbox1",'V',0,d2,0,3,&couleur2); 
// box6=creer_Box(box6);
// fix=ajouter_Fixed(fix,box6->box.elem,c9);

// Monlabel* label2=NULL;
// label2=init_label("label principale","Le Covid-19 est ",box6->box.elem,d3,NULL);
...
bouton9=init_Button(NULL,NULL,NULL,d4,"Malade",NULL,2,0,&couleur1);
bouton9=creer_Bouton(bouton9);
bouton10=init_Button(bouton9->button.elem,NULL,NULL,d4,"Suspect",NULL,2,0,&couleur1);
bouton10=creer_Bouton(bouton10);
bouton11=init_Button(bouton9->button.elem,NULL,NULL,d4,"Guéri",NULL,2,0,&couleur1);
bouton11=creer_Bouton(bouton11);
bouton12=init_Button(bouton9->button.elem,NULL,NULL,d4,"Sain",NULL,2,0,&couleur1);
bouton12=creer_Bouton(bouton12);
...
box7=ajouter_Box(box7,bouton12->button.elem,0,0,0,1);

fix=ajouter_Fixed(fix,FF4->frame.elem,c10);
...
fix=ajouter_Fixed(fix,boxbutton->box.elem,c11);
...
boxbutton=ajouter_Box(boxbutton,boutonadd->button.elem,0,0,0,1);
boxbutton=ajouter_Box(boxbutton,boutonquite->button.elem,0,0,0,1);


//Create Fenetre 2 Type Dialog :
...
//Création des GTKEntry forum login
//Création 5em frame
...
fix=ajouter_Fixed(fix,FF5->frame.elem,c12);
...
fix=ajouter_Fixed(fix,FF6->frame.elem,c121);


//boxe toolbar
MonBox *boxtoolbar=NULL;
boxtoolbar=Init_box(NULL,"sousbox1",'V',1,d2,1,0,&couleur1); 
boxtoolbar=creer_Box(boxtoolbar);
fix=ajouter_Fixed(fix,boxtoolbar->box.elem,c13);
...
//toolbar
  ...
  boxtoolbar=ajouter_Box(boxtoolbar,toolbr,0,0,0,1);


//Add signale to Button Quite
g_signal_connect(boutonquite->button.elem,"clicked",G_CALLBACK(gtk_main_quit),scrollbar->parent);
g_signal_connect(boutonadd->button.elem,"clicked",G_CALLBACK(on_ok_button),scrollbar->parent);
